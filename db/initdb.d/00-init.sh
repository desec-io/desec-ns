...
echo -n "CHANGE MASTER TO MASTER_HOST='${DESECSTACK_DBMASTER}', MASTER_USER='${DESECSTACK_DBMASTER_USERNAME_ns1replication}', MASTER_PASSWORD='${DESECSTACK_DBMASTER_PASSWORD_ns1replication}', MASTER_SSL=1, MASTER_SSL_CA='/etc/ssl/private/ca.pem', MASTER_SSL_CERT='/etc/ssl/private/${DESECSTACK_DBMASTER_SUBJECT_ns1replication}-cert.pem', MASTER_SSL_KEY='/etc/ssl/private/${DESECSTACK_DBMASTER_SUBJECT_ns1replication}-key.pem', " > 21-pdns-CHANGEMASTER.sql
